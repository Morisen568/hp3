...
<html lang="ja">
  <head>
    ...
    if (windowwidth > 768){
      var responsiveImage = [
        { src: '<?php echo get_template_directory_uri();?>/images/spring/sakura.jpg'},
        { src: '<?php echo get_template_directory_uri();?>/images/summer/summer.jpg'},
        { src: '<?php echo get_template_directory_uri();?>/images/autumn/fall.jpg' },
        { src: '<?php echo get_template_directory_uri();?>/images/winter/fuyu.jpg'}
      ];
    } else {
      var responsiveImage = [
        { src: '<?php echo get_template_directory_uri();?>/images/spring/sakura.jpg'},
